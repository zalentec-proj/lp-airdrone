...
export default function Home() {
  ...
  return <>
    ...
    <main id="conteudo">
      ...
      <section className="section section-light reviews" id="avaliacoes"><SectionTracker id="avaliacoes" index={8} /><div className="container"><SectionHeading eyebrow="QUEM JÁ CONFIOU NA AIRDRONE" title="Experiências de clientes que voltaram a voar." /><div className="review-grid">{reviews.map((review) => <blockquote key={review.name}><span>“</span><p>{review.text}</p><footer>{review.name}</footer></blockquote>)}</div><div className="review-cta"><WhatsAppLink className="button button-outline-dark" location="footer" label="Solicitar orçamento">Solicitar orçamento</WhatsAppLink></div></div></section>
    </main>
